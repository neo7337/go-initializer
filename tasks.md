...
- [x] **T38 — [Infra] Create Homebrew tap** — create `github.com/neo7337/homebrew-goini` repository with `Formula/goini.rb`; formula installs the binary and all three shell completion scripts (bash, zsh, fish)
